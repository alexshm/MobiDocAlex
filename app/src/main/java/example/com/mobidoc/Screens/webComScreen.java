...
public class webComScreen extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                baseUrl = "http://" + "mobidoc.ise.bgu.ac.il" + ":8081/openmrs-standalone/ws/";
    ...
    private void getRecTest() {
        ...
        String obsss = openMrsApi.getPatintUuid();
        ans.setText(obsss);
        String[] obsss4 = openMrsApi.getPreferences();
        ans.setText(obsss4[3]);
